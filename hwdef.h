...
// SPI device table
#define HAL_SPI_DEVICE0  SPIDesc("mpu9250"        ,  0,  4, PAL_LINE(GPIOE,12U), SPIDEV_MODE3,   2*MHZ,   4*MHZ)
...
// GPIO config
#define HAL_GPIO_LINE_GPIO0 PAL_LINE(GPIOC, 13U)
...
{   0, true,  0, PAL_LINE(GPIOC, 13U)}, /* PC13 LED_RED OUTPUT */ \
{   1, true,  0, PAL_LINE(GPIOC, 14U)}, /* PC14 LED_GREEN OUTPUT */ \
{   2, true,  0, PAL_LINE(GPIOC, 15U)}, /* PC15 LED_BLUE OUTPUT */ \
...
#define HAL_GPIO_PIN_LED_BLUE             PAL_LINE(GPIOC,15U)
#define HAL_GPIO_PIN_LED_GREEN            PAL_LINE(GPIOC,14U)
#define HAL_GPIO_PIN_LED_RED              PAL_LINE(GPIOC,13U)
#define HAL_GPIO_PIN_LED_SAFETY           PAL_LINE(GPIOC,2U)
#define HAL_GPIO_PIN_MPU9250_CS           PAL_LINE(GPIOE,12U)
...
#define HAL_GPIO_PIN_VDD_SENSORS_EN       PAL_LINE(GPIOE,3U)

#define HAL_INS_PROBE1  ADD_BACKEND(AP_InertialSensor_Invensense::probe(*this,hal.spi->get_device("mpu9250"),ROTATION_ROLL_180_YAW_90))
#define HAL_INS_PROBE_LIST HAL_INS_PROBE1

#define HAL_MAG_PROBE1  ADD_BACKEND(DRIVER_AK8963, AP_Compass_AK8963::probe_mpu9250(0,ROTATION_ROLL_180_YAW_90))
...
#define HAL_I2C2_CONFIG { &I2CD2, STM32_I2C_I2C2_RX_DMA_STREAM, STM32_I2C_I2C2_TX_DMA_STREAM, PAL_LINE(GPIOB,10U), PAL_LINE(GPIOB,11U) }
#else
#define HAL_I2C2_CONFIG { &I2CD2, SHARED_DMA_NONE, SHARED_DMA_NONE, PAL_LINE(GPIOB,10U), PAL_LINE(GPIOB,11U) }
#endif

#define HAL_I2C_DEVICE_LIST HAL_I2C1_CONFIG,HAL_I2C2_CONFIG
...
#define HAL_UART4_CONFIG { (BaseSequentialStream*) &SD4, false, STM32_UART4_RX_DMA_CONFIG, STM32_UART4_TX_DMA_CONFIG, PAL_LINE(GPIOA,0U), PAL_LINE(GPIOA,1U), 0, -1, 0, -1, 0}
...
#define HAL_USART3_CONFIG { (BaseSequentialStream*) &SD3, false, STM32_USART3_RX_DMA_CONFIG, STM32_USART3_TX_DMA_CONFIG, PAL_LINE(GPIOD,8U), PAL_LINE(GPIOD,9U), 0, -1, 0, -1, 0}
...
#define HAL_UART7_CONFIG { (BaseSequentialStream*) &SD7, false, STM32_UART7_RX_DMA_CONFIG, STM32_UART7_TX_DMA_CONFIG, PAL_LINE(GPIOE,8U), PAL_LINE(GPIOE,7U), 0, -1, 0, -1, 0}
#define AP_FEATURE_RTSCTS 1
#define HAL_UART_DEVICE_LIST HAL_OTG1_CONFIG,HAL_UART4_CONFIG,HAL_USART2_CONFIG,HAL_USART3_CONFIG,HAL_UART8_CONFIG,HAL_USART1_CONFIG,HAL_UART7_CONFIG
...
/* PORTC:
 ...
 PC13 LED_RED OUTPUT
 PC14 LED_GREEN OUTPUT
 PC15 LED_BLUE OUTPUT
*/
