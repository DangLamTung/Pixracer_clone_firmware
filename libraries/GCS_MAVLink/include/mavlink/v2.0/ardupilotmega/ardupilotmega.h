...
typedef enum MAV_CMD
{
   ...
   MAV_CMD_DO_GRIPPER=211, /* Mission command to operate EPM gripper. |Gripper instance number (from 1 to max number of grippers on the vehicle).| Gripper action.| Empty.| Empty.| Empty.| Empty.| Empty.|  */
   ...
   MAV_CMD_DO_WINCH=42600, /* Command to operate winch. |Winch instance number (0 for the default winch, otherwise a number from 1 to max number of winches on the vehicle).| Action.| Release length (cable distance to unwind, negative numbers to wind in cable).| Release rate.| Empty.| Empty.| Empty.|  */
