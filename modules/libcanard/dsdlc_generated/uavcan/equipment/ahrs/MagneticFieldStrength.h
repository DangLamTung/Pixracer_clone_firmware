 ...
 *
 * Source file: /home/tung/ardupilot/modules/uavcan/dsdl/uavcan/equipment/ahrs/1001.MagneticFieldStrength.uavcan
 */
...
/**
  * @brief uavcan_equipment_ahrs_MagneticFieldStrength_encode_internal
  ...
  */
uint32_t uavcan_equipment_ahrs_MagneticFieldStrength_encode_internal(uavcan_equipment_ahrs_MagneticFieldStrength* source,
  void* msg_buf,
  uint32_t offset,
...
/**
  * @brief uavcan_equipment_ahrs_MagneticFieldStrength_encode
  * @param source : Pointer to source data struct
  * @param msg_buf: Pointer to msg storage
...
uint32_t uavcan_equipment_ahrs_MagneticFieldStrength_encode(uavcan_equipment_ahrs_MagneticFieldStrength* source, void* msg_buf)
{
    ...
    offset = uavcan_equipment_ahrs_MagneticFieldStrength_encode_internal(source, msg_buf, offset, 1);

    return (offset + 7 ) / 8;
}

/**
  * @brief uavcan_equipment_ahrs_MagneticFieldStrength_decode_internal
  * @param transfer: Pointer to CanardRxTransfer transfer
  * @param payload_len: Payload message length
  * @param dest: Pointer to destination struct
  * @param dyn_arr_buf: NULL or Pointer to memory storage to be used for dynamic arrays
  *                     uavcan_equipment_ahrs_MagneticFieldStrength dyn memory will point to dyn_arr_buf memory.
  *                     NULL will ignore dynamic arrays decoding.
  * @param offset: Call with 0, bit offset to msg storage
  * @retval offset or ERROR value if < 0
  */
int32_t uavcan_equipment_ahrs_MagneticFieldStrength_decode_internal(
  const CanardRxTransfer* transfer,
  uint16_t CANARD_MAYBE_UNUSED(payload_len),
  uavcan_equipment_ahrs_MagneticFieldStrength* dest,
  ...
  int32_t offset)
{
    ...
    for (c = 0; c < 3; c++)
    {
        ...
        if (ret != 16)
        {
            goto uavcan_equipment_ahrs_MagneticFieldStrength_error_exit;
        }
        offset += 16;
    }
...
uavcan_equipment_ahrs_MagneticFieldStrength_error_exit:
    if (ret < 0)
    {
        return ret;
    }
...
/**
  * @brief uavcan_equipment_ahrs_MagneticFieldStrength_decode
  * @param transfer: Pointer to CanardRxTransfer transfer
  * @param payload_len: Payload message length
  * @param dest: Pointer to destination struct
  * @param dyn_arr_buf: NULL or Pointer to memory storage to be used for dynamic arrays
  ...
  * @retval offset or ERROR value if < 0
  */
int32_t uavcan_equipment_ahrs_MagneticFieldStrength_decode(const CanardRxTransfer* transfer,
  ...
  uint8_t** dyn_arr_buf)
{
    ...
    for (uint32_t c = 0; c < sizeof(uavcan_equipment_ahrs_MagneticFieldStrength); c++)
    {
        ((uint8_t*)dest)[c] = 0x00;
    }

    ret = uavcan_equipment_ahrs_MagneticFieldStrength_decode_internal(transfer, payload_len, dest, dyn_arr_buf, offset);
