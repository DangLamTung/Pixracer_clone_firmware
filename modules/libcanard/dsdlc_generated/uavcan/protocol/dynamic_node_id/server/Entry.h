 ...
 *
 * Source file: /home/tung/ardupilot/modules/uavcan/dsdl/uavcan/protocol/dynamic_node_id/server/Entry.uavcan
 */
...
/**
  * @brief uavcan_protocol_dynamic_node_id_server_Entry_encode_internal
...
/**
  * @brief uavcan_protocol_dynamic_node_id_server_Entry_encode
  * @param source : Pointer to source data struct
  * @param msg_buf: Pointer to msg storage
...
uint32_t uavcan_protocol_dynamic_node_id_server_Entry_encode(uavcan_protocol_dynamic_node_id_server_Entry* source, void* msg_buf)
{
    ...
    offset = uavcan_protocol_dynamic_node_id_server_Entry_encode_internal(source, msg_buf, offset, 1);

    return (offset + 7 ) / 8;
}

/**
  * @brief uavcan_protocol_dynamic_node_id_server_Entry_decode_internal
...
int32_t uavcan_protocol_dynamic_node_id_server_Entry_decode_internal(
  ...
  uavcan_protocol_dynamic_node_id_server_Entry* dest,
...
uavcan_protocol_dynamic_node_id_server_Entry_error_exit:
    if (ret < 0)
    {
        return ret;
    }
...
/**
  * @brief uavcan_protocol_dynamic_node_id_server_Entry_decode
  * @param transfer: Pointer to CanardRxTransfer transfer
  * @param payload_len: Payload message length
  * @param dest: Pointer to destination struct
  * @param dyn_arr_buf: NULL or Pointer to memory storage to be used for dynamic arrays
  ...
  * @retval offset or ERROR value if < 0
  */
int32_t uavcan_protocol_dynamic_node_id_server_Entry_decode(const CanardRxTransfer* transfer,
  ...
  uint8_t** dyn_arr_buf)
{
    ...
    for (uint32_t c = 0; c < sizeof(uavcan_protocol_dynamic_node_id_server_Entry); c++)
    {
        ((uint8_t*)dest)[c] = 0x00;
    }

    ret = uavcan_protocol_dynamic_node_id_server_Entry_decode_internal(transfer, payload_len, dest, dyn_arr_buf, offset);
