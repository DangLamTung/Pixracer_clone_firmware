 ...
 *
 * Source file: /home/tung/ardupilot/modules/uavcan/dsdl/uavcan/protocol/enumeration/15.Begin.uavcan
 */
  ...
  int32_t offset)
{
    ...
    ret = canardDecodeScalar(transfer, (uint32_t)offset, 16, false, (void*)&dest->timeout_sec);
    if (ret != 16)
    {
