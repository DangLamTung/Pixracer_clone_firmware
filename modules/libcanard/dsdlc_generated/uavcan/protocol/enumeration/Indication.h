 ...
 *
 * Source file: /home/tung/ardupilot/modules/uavcan/dsdl/uavcan/protocol/enumeration/380.Indication.uavcan
 */
  ...
  int32_t offset)
{
    ...
    // Compound
    offset = uavcan_protocol_param_NumericValue_decode_internal(transfer, payload_len, &dest->value, dyn_arr_buf, offset);
    if (offset < 0)
    {
        ret = offset;
